...
def is_rain_week(we) :
    ...
    if we == 100 or we == 101 or we == 111 or we == 200 or we == 201 or we == 211 or we == 104 or we == 105 or\
       we == 117 or we == 550 or we == 552 or we == 582 or we == 562 or we == 572:
        return False
