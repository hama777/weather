...
def is_rain_week(we) :
    ...
    if we == 102 or we == 103 or we == 106 or we == 114 or  we == 202 or we == 206 or we == 260 or\
       ...
       we == 882 or we == 872 or we == 852 or we == 850 or we == 553 or we == 563 or we == 861 or we == 862 :
        return True
    # 晴れ
    # 105 晴時々雪   117 晴のち雪    550 猛暑
    if we == 100 or we == 101 or we == 110 or we == 111 or we == 200 or we == 201 or we == 210 or we == 211 or\
       we == 104 or we == 105 or we == 117 or we == 550 or we == 552 or we == 582 or we == 562 or we == 572:
        return False
